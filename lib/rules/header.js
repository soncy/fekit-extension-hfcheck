...
(function() {
  var KEYWORDS, checkCss, checkLess, checkSass, checkSelector, errorMsg, fs, getStyles, isStartWithKeyword, isTagName, legitimateStartWord, less, mediaReg, parseMediaStyle, path, reg, sass, uglifycss, warningMsg;
  ...
  checkSelector = function(styles) {
    ...
    return illegalTagName.length > 0 && warningMsg.push((illegalTagName.join(',')) + "没有命名空间，请在2015年8月1日之前完成修改");
  };
