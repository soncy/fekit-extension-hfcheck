...
(function() {
  var KEYWORDS, checkCss, checkLess, checkSass, checkSelector, errorMsg, fs, getStyles, isStartWithKeyword, isTagName, legitimateStartWord, less, mediaReg, parseMediaStyle, path, reg, sass, uglifycss;
  ...
  isTagName = function(str) {
    ...
    legitimateStartWord.forEach(function(word) {
      if (str.indexOf(word) === 0 && word.split('.').length > 0) {
        return ret = false;
      }
    });
    return ret;
